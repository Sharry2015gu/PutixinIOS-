...
- (id)initWithImage:(UIImage *)image text:(NSString *)text {
    if ((self = [self initWithFrame:[self.class defaultFrame]])) {
        self.image = image;
//        self.image = [UIImage imageNamed:@"show_page_bg"];
        self.text = text;
...
//    self.imageView.alpha = currentOpacity > 0 ? 1.0f : 0.0f;
    ...
    self.backgroundView.backgroundColor = [[UIColor colorWithPatternImage:[UIImage imageNamed:@"show_page_bg"]] colorWithAlphaComponent:currentOpacity];
...
- (UIView *)backgroundView {
    ...
    _backgroundView.backgroundColor = [[UIColor colorWithPatternImage:[UIImage imageNamed:@"show_page_bg"]] colorWithAlphaComponent:0.0f];
...
- (UIImageView *)imageView {
    ...
    _imageView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"show_page_bg"]];
