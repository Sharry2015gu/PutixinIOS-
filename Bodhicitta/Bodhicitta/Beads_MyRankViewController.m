...
@interface Beads_MyRankViewController ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong)UITableView * tableview;
@property(nonatomic,strong)NSMutableArray * resultArray;

@end

@implementation Beads_MyRankViewController
...
{
    self.tableview = [[UITableView alloc] initWithFrame:CGRectMake(0,NAVBARHEIGHT*0.1+110,SCREEN_WIDTH,SCREEN_HEIGHT - NAVBARHEIGHT-5+10)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Beads_MyRankViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellId];
    if (cell == nil) {
        cell = [[Beads_MyRankViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
